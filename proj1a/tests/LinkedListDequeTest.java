...
public class LinkedListDequeTest {
    ...
    public void removeFirstAndRemoveLastTest(){
        ...
        lld1.addFirst(4);
        lld1.addFirst(5);
        int removeFirst = lld1.removeFirst();
        assertThat(removeFirst).isEqualTo(5);
        int removeLast = lld1.removeLast();
        assertThat(removeLast).isEqualTo(0);
    }
}